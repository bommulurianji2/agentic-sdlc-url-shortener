...
Records every human gate decision for this project. This is the pre-code, bootstrapping record — once the `approvals` table (detailed-technical-design.md §1) and `scripts/approve_gate.py` exist (build-plan task 15), those become the system of record and this file is superseded, not duplicated going forward.

| Workflow | Gate | Approver | Decision | Artifact versions | Comments | Date |
|---|---|---|---|---|---|---|
